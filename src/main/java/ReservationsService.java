...
public class ReservationsService {
    ...
    /**
     * Reserves the specified number of seats in the given Theater object for the provided customer name
     * and according to their wheelchair accessibility requirements.
     *
     ...
     * @throws IllegalArgumentException if the number of seats is negative or 0, or the customer name is empty
     */
